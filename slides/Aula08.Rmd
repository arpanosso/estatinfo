...
Nestas condições, a variável aleatória $X$ com distribuição Binomial apresenta:
...
Observe que o último argumento da função é o valor zero $0$, que representa que a probabilidade não deve ser acumulada.
