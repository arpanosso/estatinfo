...
Se $P(\mho) = \sum \limits_{i=1}^\infty \frac{e^{-\lambda}\lambda^x}{x!}$, então:

$P(x >2 ) = 1 - \sum \limits_{i=0}^2\frac{e^{-\lambda}\lambda^x}{x!}$

$P(x >2 ) = 1 - P(X=0) + P(X=1) + P(X=2)$

$P(x >2 ) = \frac{e^{-5}5^0}{0!} + \frac{e^{-5}5^1}{1!}+\frac{e^{-5}5^2}{2!}=0,87535$
...
$P(X > 4)= 1 - P(X \le 4) = 1 - \sum_{i=0}^{4}Po(2)$

$P(X > 4)= 1 - P(X \le 4) = 1 - \sum_{i=0}^{4}Po(2)=0,0526$
