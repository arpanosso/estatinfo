...
- Utilizar as ferramentas computacionais para apresentação os resumos e análises de dados.
...
- Aula teóricas de anos anteriores serão disponibilizadas (**Google Classroom**).
