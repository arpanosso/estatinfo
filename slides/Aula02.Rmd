...
m=0:100
f=m*a
plot(f~m,xlim=c(0,10),ylim= c(0,25),pch=16,col="black",cex=2,
     las=1,xlab="Massa (kg)",ylab="Força (N)",cex.lab=1.3); text(5,20,"a = 2 m/s²",font=3) 
points(f~m,type="l",col="red",lwd=2)
```
