...
subtitle: "Aula 11 - Testes de Hipótese"
...
```{r,echo=FALSE}
curve(dnorm(x,500,25),425,575,col="blue",
      xlab = "Ganho de peso (g/dia/suíno)",ylab = "Densidade")
abline(v=500, col="blue")
curve(dnorm(x,510,25),add=TRUE,col="red")
...
curve(dnorm(x,500,25/sqrt(50)),485,525,col="blue",
      xlab = "Ganho de peso Médio (g/dia/suíno)",ylab = "Densidade")
abline(v=500, col="blue")
curve(dnorm(x,510,25/sqrt(50)),add=TRUE,col="red")
abline(v=510,col="red")
segments(505,0,505,dnorm(505,510,25/sqrt(50)))
```
---
...
Por exemplo, se o verdadeiro valor do parâmetro $\mu$ é $500\;g$ e incorretamente concluímos que $\mu = 510\;g$, cometeremos um erro referido como **ERRO TIPO I (falso positivo)**. 
