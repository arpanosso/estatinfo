...
# Acesse o Link para simularmos essa amostragem. Aba "Ditruição Amostral  - Média"
...
Seja uma máquina de empacotamento de soja, cujos pesos (em $kg$) seguem uma distribuição $N(50, 2)$. Assim, se a máquina estiver regulada, qual a probabilidade de, colhendo-se uma amostra de $100$ sacas ao acaso, observarmos uma média diferente de $50 \;kg$ em menos de $0,2828 \; kg$?
...
Portanto, a proporção amostral de suscessos éem $n$ ensaios é dada por:
...
$Z = \frac{\hat{p} - p}{\sqrt{\frac{p.q}{n}}}$ ou $Z = \frac{T - n.p}{\sqrt{n.p.q}}$ tem distribuição apromadamente normal padrão $N(0,1)$.

---

### Exercício

Em um ensaio experimental $625$ covas foram semeadas com sementes comercias provenientes de um lote com índice de germinação $(p)$ igual a $70\%$. 
