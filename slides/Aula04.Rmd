...
$$
\bar{x} = \frac{\sum_{i=1}^nx_i}{n} = \frac{19+20+ \cdots+23}{44} = 21,04545\text{ anos} 
$$
...
\bar{x} & = 18\cdot(0,1363)+19\cdot(0,3181818	) + \cdots + 49(0,0227273) \\
\bar{x} & = 21,04545\;anos
\end{align}
$$
...
$$
\bar{x} = \frac{1,68 + 1,59 + \cdots+1,80}{44} =  1,7257\text{ m}
$$
