...
```{r echo=FALSE, fig.cap="Pacotes no R são coleções de funções, exemoplos e documentações, os quais devem ser previamente instalados e alocados no ambiente por meio da função `library`.",fig.align='center',out.width = "550px"}
