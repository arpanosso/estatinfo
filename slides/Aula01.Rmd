...
Assim, os objetivos dessa aula serão:
  ...
  + Treinamento do encademamento lógico e organizado do pensamento. 
...
Identar é afastar o texto de sua margem, com espaços ou tabulações, que tem como objetivo criar uma hierarquia entre os blocos das instruções para essaltar ou definir a estrutura do algoritmo.
...
```{r, eval=FALSE}
if; else for; while; repeat; break; function
