...
```{r,out.width = "50%",fig.cap="",fig.align = 'center',echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/arpanosso/estatinfo/master/slides/img/hist_15.png")
```
...
**b)** que peso $(x)$ deve atingir um bezerro para que ele supere $80\%$ dos pesos à desmama desse rebanho?

```{r,out.width = "60%",fig.cap="",fig.align = 'center',echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/arpanosso/estatinfo/master/slides/img/hist_16.png")
```
...
$$P(7 \le X \le 10) = P \left( \frac{(\frac{7-0,5}{15})-0,4}{\sqrt{\frac{0,4(1-0,4)}{15}}} \le Z \le \frac{(\frac{10+0,5}{15})-0,4}{\sqrt{\frac{0,4(1-0,4)}{15}}} \right)$$
