...
**Experimentos**: fazer ou observar alguma coisa sob certas condições, resultando em algum estado final de acontecimentos ou resultados.
...
A título de exemplificação, vamos definir uma variável **aleatória (v.a.)** como $X$ que representa o **número de caras** no lançamento de duas moedas, ou no lançamenteo de uma moeda duas vezes, temos:
...
Dada a seguinte tabela, referente ao sexo $(F, M)$ e a cor do cabelo de crianças em uma escola:


 | Ruivo | Não Ruivo | TOTAL
---|:---:|:---:|:---:|---:
**Feminino** | 4  | 26 | **30**
**Masculino** | 17 | 13 | **30** 
**TOTAL** | **21** | **39** | **60**
...
$0,58 = 0,58$ VERDADEIRO, então concluímos que os eventos **SÃO** independentes, ou seja, a cor do cableo não depende do sexo.
