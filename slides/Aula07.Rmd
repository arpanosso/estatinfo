...
.pull-left[
```{r,out.width = "40%",fig.cap="Portrait of Pierre-Simon Laplace by Johann Ernst Heinsius (1775). Fonte: Wikipedia",fig.align = 'center',echo=FALSE}
...
>Assim, $P(E)$ é a probabilidade de um evento E, ou seja, um número entre $0$ e $1$, quanto mais próximo a 1, maior a chance de sua ocorrência. 
...
$i) \;0 \le P(E) \le 1, \forall E \subset \mho$.
...
Dada a seguinte tabela, referente ao sexo $(F, M)$ e a cor do cabelo (*Ruivos* e *Não Ruivos*) de crianças em uma escola mista:
...
$0,58 = 0,58$ VERDADEIRO, então concluímos que os eventos **SÃO** independentes, ou seja, a cor do cabelo não depende do sexo.
