...
subtitle: "Aula 07 - Variáveis Aleatórias Discretas"
...
Por exemplo, se o período de tempo considerado para o exemplo anterior for de dois minutos, teremos que o número de partículas emitidas em dois minutos terá distribuição: $\lambda'= 2 \times 5 = 10$ partículas em dois minutos.
