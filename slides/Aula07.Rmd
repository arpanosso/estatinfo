...
O exemplo clássico de independência e não infependência entre eventos será apresnetado a seguir. Imagine uma urna contento 2 bolas brancas e 3 bolas vermelhas. Serão sorteados duas bolas com reposição, ou seja, sorteia-se a primeira bola, anotá-se a cor, devolve-se a bola para a urna e realiza-se o segundo sorteio, Nessas condições o espaço amostral desse ensaio segudo de suas respectivas probabilidades de ocorrência, pode ser dado por: $\mho = \{ BB, BV, VB, VV\}$
