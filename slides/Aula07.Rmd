...
---
#### Teorema de Bayes  
Considere a incidência de uma doença na população humana  nas diferentes faixas etárias: *jovens*, *adultos* e *idosos*, $E_1$, $E_2$ e $E_3$, respectivamente.

```{r,out.width = "50%",fig.cap="",fig.align = 'center',echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/arpanosso/estatinfo/master/slides/img/Bayes.png")
```
Sabe-se que $P(E_1) = 0,60$, $P(E_2) = 0,30$ e $P(E_3) = 0,10$, além disso, é conhecido que as incidências da doença nas diferentes faizas etárias são:
.pull-left[
$P(D|E_1)=0,02$  
$P(D|E_2)=0,05$  
$P(D|E_3)=0,10$  
Toma-se  uma  pessoa dessa população  ao  acaso  e  verificamos que ela está doente.
]
.pull-right[
   Qual  a probabilidade da pessoa escolhida pertencer à faixa etária $E_1$, ou seja ?
$$P(E_1|D) = ?$$
]

---

Aplicando a fórmula da probabilidade condicional, temos que:
...
O evento Doente pode se escrito como a reunião de 3 eventos disjuntos, ou seja:
