...
É o valor que ocupa a posição central do conjunto ordenado dos dados $(X' \text{ ou } Xo)$, o valor da mediana é precedido e seguido pelo mesmo  número de observações e nem sempre pertence ao conjunto de dados.  
...
No exemplo, temos $n$ ímpar, a mediana faz parte do conjunto de dados e será encontrada como:  
...
Dado $X=\{50, 60, 20, 50, 30, 90, 70\}$, teremos a sua versão ordenada $X_0$ dado por:
