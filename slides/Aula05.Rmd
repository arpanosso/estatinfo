...
No R, vamos utilizar a função `skewness()` do pacote `agricolae` para calcular o coeficiente de assimetria dos dados. A função `pull()` extrai da base `dados_turmas` os valores de  `idade_anos`para ser passados em `skewness()`.
