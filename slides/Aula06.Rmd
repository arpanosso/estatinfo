...
**Conjunto Complementar**: Seja $A$ um subconjunto de $U$ , isto é $A \subet U$. Então estamos interessados nos elementos de $U$ que não pertencem a $A$. Ele formam um novo conjunto, que é chamado **"o complementar de A em U"**. Representado por: $\bar{A}$ ou $A^c$.
