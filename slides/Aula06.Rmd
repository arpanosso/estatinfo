...
Conjuntos de qualquer tipo de elementos são representados por conjunto de pontos. 

Para simplificação do desenho, são utilizados pontos em um **círculo ou em um retângulo**. 
